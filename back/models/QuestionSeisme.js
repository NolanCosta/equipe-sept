...
const questionSeisme = [
  ...
  },
  {
    ...
    question:
      "Soudain, des secousses renverse tout ses crayons, vite que faire!?",
    choices: [
      "Je me réfugie sur le balcon.",
      "Je me met sous une table ou dans un coin de ma chambre.",
    ],
  ...
  },
  {
    ...
    choices: [
      "Je regardes par la fenetre pour voir la situations.",
      "Je termines mon dessin!",
    ],
  ...
  },
  {
    ...
    choices: [
      "Je vais prévenir mes parents, il faut se préparer!",
      "Mon dessin!!!",
    ],
  ...
  },
  {
    ...
    question:
      "Avec tes parents tu prépares un sac d’évacuations que mettre dedans?",
    choices: [
      "Nourriture/Eau, vêtements chauds et lampe à pile.",
      "Jouets, Skateboard et trousse d’école",
    ],
  ...
  },
  {
    ...
    question:
      "En partant vous hésitez entre prendre les escalier ou l’ascenseur, vous prennez?",
