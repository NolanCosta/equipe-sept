  ...
  return (
    <>
      <div className="pt-20">
        ...
        <p className = "text-2xl text-black">Une inondation est quand il y a trop d'eau qui déborde des rivières ou de la mer et recouvre la terre, les rues et parfois les maisons.</p>
