  ...
  return (
    <>
      <div className="pt-20">
        ...
        <p className = "text-2xl text-black">Un tremblement de terre est quand le sol tremble ou bouge très fort à cause de mouvements sous la terre, et cela peut casser des bâtiments et créer des fissures.</p>
